...
![Modular Structure](../images/modular.png){width=100px}
...
![YAML Centralization File with Configuration Values](../images/yaml.png)
- Added a console logging system to simplify debugging and system monitoring.

	![Entry Screen for GaiaML CLI](../images/main_screen.png)
